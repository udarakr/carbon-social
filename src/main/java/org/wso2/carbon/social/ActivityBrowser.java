...
public class ActivityBrowser {
    ...
    public double getRating(String targetId, String tenant, int limit, String sinceId) {
        ...
        JsonObject socialObject = getSocialObject(targetId, tenant, null, limit, sinceId);
    ...
    public JsonObject getSocialObject(String targetId, String tenant, SortOrder order, int limit, String sinceId) {
        List<Activity> activities = listActivitiesChronologically(targetId, tenant, limit, sinceId);
    ...
    public List<Activity> listActivities(String contextId, String tenantDomain, int limit, String sinceId) {
    ...
    public List<Activity> listActivitiesChronologically(String contextId, String tenantDomain, int limit, String sinceId) {
        List<Activity> activities = listActivities(contextId, tenantDomain, limit, sinceId);
